#!/bin/sh
#
# $Id: lan.sh,v 1.22 2008-07-01 02:52:11 chhung Exp $
#
# usage: wan.sh
#
...
if [ "$host" = "" ]; then
	host="KN-WR922"
	nvram_set 2860 HostName KN-WR922
fi
hostname $host
echo "127.0.0.1 localhost.localdomain localhost" > /etc/hosts
echo "$ip $host.hexicomtech.com $host" >> /etc/hosts
