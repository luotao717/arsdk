  ...
  <tr>
    <td style="padding-top:30px;">
       ...
       <form method="post" name="security_form" action="/goform/APSecurity">
          <tr>
            <td class="nav">当前路径:KN-WR922 &gt;&gt;无线设置 &gt;&gt;无线访问策略 </td>
          </tr>
		      <tr>
            <td>&nbsp;</td>
          </tr>
          <tr>
          	<td class="space" style="padding-left:10px; padding-right:10px;">&nbsp;&nbsp;&nbsp;本页面提供了对无线访问策略的设置,可以设置允许和拒绝所选的MAC地址的接入，此功能可以配合不同的SSID使用.<input type="button" class="button5" value="帮助" onclick=popHelp('help.htm#wlactrl')></td>
       		</tr>
		  <tr>
        	<td>&nbsp;</td>
      	  </tr>
          <tr>
            <td>
			  <table class="space" width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td width="35%" class="contentpadding" id="secureSSIDChoice">SSID 选择</td>
                  <td width="65%"><select name="ssidIndex" size="1" onChange="selectMBSSIDChanged()">
...
for(aptable = 0; aptable < MBSSID_MAX; aptable++){
	...
	document.write("<tr><td class=titlebg colspan=2 >"+"无线访问策略"+"</td></tr>");
	document.write("<tr><td class=contentpadding width=35%>"+"功能:"+"</td>");
	document.write("<td><select name=apselect_"+ aptable + " id=apselect_"+aptable+" size=1 onchange=\"setChange(1)\">");
	document.write("<option value=0 >"+"禁用"+"</option> <option value=1 >"+"允许"+"</option><option value=2 >"+"拒绝"+"</option></select>(注意：在同一个SSID下的所有增加条目只能采用其中的一个策略) </td></tr>");
	document.write("<tr><td class=contentpadding>"+"新增："+"</td>");
	document.write("<td><input name=newap_text_"+aptable+" id=newap_text_"+aptable+" size=16 maxlength=20>(格式如：00:ed:23:da:eb:18 )</td></tr>");
	...
	for(i=0; i< ACCESSPOLICYLIST_MAX/2; i++){
		...
		document.write(i*2);
		document.write("> <td class=contentpadding id=");
		document.write(td_name);
		document.write("> <input class=button value=\"删 除\" onclick=\"delap("+aptable+", ");
		document.write(2*i);
	...
	document.write("</table>");
          ...
          <tr>
            <td class="contentpadding"><input type="hidden" value="/wir_alc.asp" name="submit-url"><input type="button" class="button" value="提 交" id="secureApply" onClick="submit_apply()" />&nbsp;&nbsp;<input type="reset" class="button"  id="secureCancel" value="取 消" onClick="window.location.reload()">       </td>
          </tr>
		  <tr>
            <td>&nbsp;</td>
          </tr>
            ...
            <td>
			  <table class="space" width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr id="div_security_infra_mode" name="div_security_infra_mode"> 
                  ...
                  <td width="75%"><select name="security_mode" id="security_mode" size="1" onChange="securityMode(1)">
			<!-- ....Javascript will update options.... -->
      </select>
				  </td>
                </tr>
		...
		<option value=None id="secureEncrypTypeNone">无</option>
      </select>
				  </td>
                </tr>
              </table>
          ...
          <tr style="visibility:hidden" id="div_wep" name="div_wep">
            <td>
			  <table class="space" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                ...
                <tr>
                  ...
                  <td width="75%" colspan="2"><select name="wep_default_key" id="wep_default_key" size="1" onChange="setChange(1)">
	...
	<option value="4" id="secureWEPDefaultKey4">密钥4</option>
      </select>
				  </td>
                </tr>
				<tr>
    			  <td rowspan="4" id="secureWEPKey">WEP 密钥</td>
                  <td width="25%" class="contentpadding" id="secureWEPKey1">WEP 密钥1：</td>
                  <td width="75%"><input name="wep_key_1" id="WEP1" maxlength="26" value="" onKeyUp="setChange(1)">&nbsp;&nbsp;<select id="WEP1Select" name="WEP1Select" onChange="setChange(1)"> 
		...
		<option value="0">Hex</option>
				...
				<tr>
                  <td width="25%" class="contentpadding" id="secureWEPKey2">WEP 密钥2：</td>
                  <td width="75%" colspan="2"><input name="wep_key_2" id="WEP2" maxlength="26" value="" onKeyUp="setChange(1)">&nbsp;&nbsp;<select id="WEP2Select" name="WEP2Select" onChange="setChange(1)">
		<option value="1">ASCII</option>
		<option value="0">Hex</option>
		</select>
				  </td>
				...
				<tr>
                  <td width="25%" class="contentpadding" id="secureWEPKey3">WEP 密钥3：</td>
                  <td width="75%" colspan="2"><input name="wep_key_3" id="WEP3" maxlength="26" value="" onKeyUp="setChange(1)">&nbsp;&nbsp;<select id="WEP3Select" name="WEP3Select" onChange="setChange(1)">
		<option value="1">ASCII</option>
		<option value="0">Hex</option>
		</select>
				  </td>
				...
				<tr>
                  <td width="25%" class="contentpadding" id="secureWEPKey4">WEP 密钥4：</td>
                  <td width="75%" colspan="2"><input name="wep_key_4" id="WEP4" maxlength="26" value="" onKeyUp="setChange(1)">&nbsp;&nbsp;<select id="WEP4Select" name="WEP4Select" onChange="setChange(1)">
		<option value="1">ASCII</option>
		<option value="0">Hex</option>
		</select>
				  </td>
		  ...
		  <tr style="visibility:hidden" id="div_wpa" name="div_wpa">
            <td>
			  <table class="space" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                ...
                <tr id="div_wpa_algorithms" name="div_wpa_algorithms"> 
                  ...
                  <td width="75%">&nbsp;<input name="cipher" id="cipher" value="0" type="radio" onClick="onWPAAlgorithmsClick(0)">TKIP &nbsp;<input name="cipher" id="cipher" value="1" type="radio" onClick="onWPAAlgorithmsClick(1)">AES &nbsp;<input name="cipher" id="cipher" value="2" type="radio" onClick="onWPAAlgorithmsClick(2)">TKIPAES &nbsp;
				  </td>
                </tr>
  				<tr id="wpa_passphrase" name="wpa_passphrase">
                  <td width="25%" class="contentpadding" id="secureWPAPassPhrase">通行口令</td>
                  <td width="75%"><input name="passphrase" id="passphrase" size="28" maxlength="64" value="" onKeyUp="setChange(1)"></td>
                </tr>
                  ...
                  <td width="75%"><input name="keyRenewalInterval" id="keyRenewalInterval" size="4" maxlength="4" value="" onKeyUp="setChange(1)"> 秒
				  </td>
                </tr>
                  ...
                  <td width="75%"><input name="PMKCachePeriod" id="PMKCachePeriod" size="4" maxlength="4" value="" onKeyUp="setChange(1)"> 分
				  </td>
                </tr>
  				<tr id="wpa_preAuthentication" name="wpa_preAuthentication">
                  <td width="25%" class="contentpadding" id="secureWPAPreAuth">预认证</td>
                  <td width="75%">&nbsp;<input name="PreAuthentication" id="PreAuthentication" value="0" type="radio" onClick="onPreAuthenticationClick(0)">禁用 &nbsp;<input name="PreAuthentication" id="PreAuthentication" value="1" type="radio" onClick="onPreAuthenticationClick(1)">启用 &nbsp;
				  </td>
                </tr>
		  ...
		  <tr style="visibility:hidden" id="div_8021x_wep" name="div_8021x_wep">
            <td>
			  <table class="space" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                ...
                <tr>
                  ...
                  <td width="75%">&nbsp;<input name="ieee8021x_wep" id="ieee8021x_wep" value="0" type="radio" onClick="onIEEE8021XWEPClick(0)"><font id="secure1XWEPDisable">禁用 &nbsp;</font><input name="ieee8021x_wep" id="ieee8021x_wep" value="1" type="radio" onClick="onIEEE8021XWEPClick(1)"><font id="secure1XWEPEnable">启用</font>
				  </td>
                </tr>
              </table>
			</td>
		  ...
		  <tr style="visibility:hidden" id="div_radius_server" name="div_radius_server">
            <td>
			  <table class="space" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                ...
                <tr>
                  ...
                  <td width="75%"><input name="RadiusServerIP" id="RadiusServerIP" size="16" maxlength="32" value="" onKeyUp="setChange(1)">
				  </td>
                </tr>
				<tr>
				...
				<tr>
                  ...
                  <td width="75%"><input name="RadiusServerSecret" id="RadiusServerSecret" size="16" maxlength="64" value="" onKeyUp="setChange(1)">
				  </td>
                </tr>
				<tr>
                  <td width="25%" id="secureRadiusSessionTimeout">&nbsp;会话超时</td>
                  <td width="75%"><input name="RadiusServerSessionTimeout" id="RadiusServerSessionTimeout" size="3" maxlength="4" value="" onKeyUp="setChange(1)">
				  </td>
                </tr>
				<tr>
                  <td width="25%" class="contentpadding" id="secureRadiusIdleTimeout">空闲超时</td>
                  <td width="75%"><input name="RadiusServerIdleTimeout" id="RadiusServerIdleTimeout" size="3" maxlength="4" value="" onKeyUp="setChange(1)" readonly>
				  </td>
                </tr>
              </table>
			</td>
