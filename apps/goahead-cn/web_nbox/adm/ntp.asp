...
function formCheck()
{
	...
	{
		if (!ipAndUrlCheckMsg(document.NTP.NTPServerIP, MM_ntp_server))
			return false;
		
		if (!rangeCheckNullMsg(document.NTP.NTPSync, 1, 300, MM_ntp_time)) 
			return false;
	}	
...
<tr style="display:none"><td><script>dw(JS_msg120)</script></td></tr>
<tr><td><hr></td></tr>
</table>
