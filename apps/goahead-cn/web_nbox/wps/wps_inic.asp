...
<tr>
  ...
  <td> <% getRaixPINASP(); %> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=submit class="button" value="Generate" name="GenPIN"></td>
</tr>
</form>
<tr>
  <td colspan="2">
...
<tr id="PINRow">
	...
	<td><input value="" name="PIN" size="10" maxlength="10" type="text"></td>
</tr>
<tr>
	<td colspan="2"><input type="submit" class="button" value="Apply" name="submitWPS" onClick="return PINPBCFormCheck();"></td>
</tr>
</table>
</form>
