...
<tr style="display:none"><td><script>dw(JS_msg161)</script></td></tr>
<tr><td><hr></td></tr>
</table>
...
<input type="hidden" name="submit-url" value="/wps/wps.asp">
<tr>
  <td colspan="2"><script>dw('<input type="submit" class=button3 value="'+BT_reset_oob+'" name="submitResetOOB">')</script></td>
</tr>
</form>
-->
</table>
