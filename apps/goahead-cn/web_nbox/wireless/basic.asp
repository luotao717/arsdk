...
{
	var w_mode = document.basic_form.wirelessmode.options.selectedIndex;
	if (document.basic_form.n_bandwidth[0].checked == true)
	{
		document.getElementById("extension_channel").style.display = "none";
		document.basic_form.n_extcha.disabled = true;
	}
...
function Load_Setting()
{
	...
	if (1*ht_bw == 0)
	{
		document.basic_form.n_bandwidth[0].checked = true;
		document.getElementById("extension_channel").style.display = "none";
		document.basic_form.n_extcha.disabled = true;
	}
	else
	{
		document.basic_form.n_bandwidth[1].checked = true;
		document.getElementById("extension_channel").style.display = "";
		document.basic_form.n_extcha.disabled = false;
	}
	...
	if (1*draft3b == 1)
	{
		document.getElementById("div_2040_coexit").style.display = "";
...
<tr style="display:none"><td><script>dw(JS_msg144)</script></td></tr>
<tr><td><hr></td></tr>
</table>
