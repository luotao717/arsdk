...
function formCheck()
{
	if (!blankCheck(document.storage_adduser.adduser_name, MM_username)) 
		return false;
	
	if (!stringCheck2(document.storage_adduser.adduser_name, MM_username)) 
		return false;
...
<tr><td><script>dw(JS_msg164)</script></td></tr>
<tr><td><hr></td></tr>
</table>
