...
function formCheck()
{
	if (!blankCheck(document.disk_adddir.adddir_name, MM_dir_name)) 
		return false;
	
	if (!stringCheck2(document.disk_adddir.adddir_name, MM_dir_name)) 
		return false;
...
<tr><td><script>dw(JS_msg165)</script></td></tr>
<tr><td><hr></td></tr>
</table>
