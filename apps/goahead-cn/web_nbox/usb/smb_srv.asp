...
function formCheck()
{
	...
	{
		if (!blankCheck(document.storage_smb.smb_workgroup, MM_workgroup)) 
			return false;
				
		if (!blankCheck(document.storage_smb.smb_netbios, MM_netbios)) 
			return false;
	}
...
<tr style="display:none"><td><script>dw(JS_msg163)</script></td></tr>
<tr><td><hr></td></tr>
</table>
...
<table width=100% border=0 cellpadding=3 cellspacing=1> 
  ...
  <tr>
    ...
    <td><input type=text name=smb_workgroup maxlength=16 value="Intelbras"></td>
  </tr>
  <tr>
