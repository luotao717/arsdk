...
function formCheck()
{
	...
	{
		if (!ipCheck(document.DMZ.DMZAddress, MM_dmz_host_ip, 0)) 
			return false;
	...
	{
		if (!blankCheck(document.DMZ.DMZAddress, MM_dmz_host_ip)) 
			return false;
		
		if (!macCheck(document.DMZ.DMZAddress, MM_dmz_host_ip)) 
			return false;
	}
...
<tr style="display:none"><td><script>dw(JS_msg133)</script></td></tr>
<tr><td><hr></td></tr>
</table>
