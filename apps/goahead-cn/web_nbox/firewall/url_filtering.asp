...
function AddWebsURLFilterClick()
{
	...
	if (!blankCheck(document.websURLFilter.addURLFilter, MM_url_address)) 
		return false;
...
<tr style="display:none"><td><script>dw(JS_msg135)</script></td></tr>
<tr><td><hr></td></tr>
</table>
...
<input type="hidden" name="submit-url" value="/firewall/url_filtering.asp">
<p><b><script>dw(MM_urlf_list)</script>:<script>document.write(JS_msg93);</script></b></p>
