...
<tr style="display:none"><td><script>dw(JS_msg147)</script></td></tr>
<tr><td><hr></td></tr>
</table>
<br>
<br>
...
<table width=100% border=0 cellpadding=3 cellspacing=1> 
  <tr>
    <td>
      <script>dw('<input type=button class=button value="'+BT_refresh+'" onClick="window.location.reload()">')</script>
    </td>
  </tr>
</table>-->
