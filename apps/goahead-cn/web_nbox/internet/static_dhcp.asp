...
function formCheck()
{
	...
	// exam mac
	if (!macCheck(document.staticDhcp.mac_address, MM_macaddr)) 
		return false;	
	...
	// exam IP address
	if (!ipCheck(document.staticDhcp.ip_address, MM_ipaddr, 0)) 
		return false;
...
<tr style="display:none"><td><script>dw(JS_msg119)</script></td></tr>
<tr><td><hr></td></tr>
</table>
...
<input type="hidden" name="submit-url" value="/internet/static_dhcp.asp">
<p><b><script>dw(MM_static_dhcp_list)</script>:<script>document.write(JS_msg137);</script></b></p>
