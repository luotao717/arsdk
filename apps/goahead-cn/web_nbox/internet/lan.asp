...
function formCheck()
{
	...
	if (document.lanCfg.dhcpStart.value == '<% getCfgGeneral(1, "dhcpStart"); %>') 
	{
		document.lanCfg.dhcpStart.value = atoi(document.lanCfg.lanIp.value, 1)+'.'+atoi(document.lanCfg.lanIp.value, 2)+'.'+atoi(document.lanCfg.lanIp.value, 3)+'.'+atoi(document.lanCfg.dhcpStart.value, 4);
		document.lanCfg.dhcpEnd.value = atoi(document.lanCfg.lanIp.value, 1)+'.'+atoi(document.lanCfg.lanIp.value, 2)+'.'+atoi(document.lanCfg.lanIp.value, 3)+'.'+atoi(document.lanCfg.dhcpEnd.value, 4);
	}
	
	if (document.lanCfg.dhcpEnd.value == '<% getCfgGeneral(1, "dhcpEnd"); %>') 
	{	
		document.lanCfg.dhcpEnd.value = atoi(document.lanCfg.lanIp.value, 1)+'.'+atoi(document.lanCfg.lanIp.value, 2)+'.'+atoi(document.lanCfg.lanIp.value, 3)+'.'+atoi(document.lanCfg.dhcpEnd.value, 4);
		document.lanCfg.dhcpStart.value = atoi(document.lanCfg.lanIp.value, 1)+'.'+atoi(document.lanCfg.lanIp.value, 2)+'.'+atoi(document.lanCfg.lanIp.value, 3)+'.'+atoi(document.lanCfg.dhcpStart.value, 4);
	}
...
<tr id="dhcpclient" style="display:none">
