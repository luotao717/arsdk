...
static char_t	websRealm[64] = T("INTELBRAS");	/* Realm name */
#elif defined (CONFIG_LKTOS_PRIVATE_OEM_NAME_CDRKING)
static char_t	websRealm[64] = T("CD-R KING");	/* Realm name */
#else 
//static char_t	websRealm[64] = T("CNU WIFI DEV");	/* Realm name */
static char_t	websRealm[64] = T("WIFI CLUND 9331");	/* Realm name */
#endif
...
void websSetEnv(webs_t wp)
{
	...
	//by luot for testupload
	//printf("\r\nquerystring=%s--%s",wp->query,websGetVar(wp, "filename", NULL));
