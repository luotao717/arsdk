...
<table width=100% border=0 cellpadding=3 cellspacing=1> 
  <tr>
    ...
    <td><input type="button" name="radioButton" value="RADIO ON" onClick="if (this.value.indexOf('OFF') >= 0) RadioStatusChange(1); else RadioStatusChange(0); document.basic_form.submit();"><input type=hidden name=radiohiddenButton value="2"></td>
  </tr>
  <tr> 
    <td colspan="2"><hr></td>
  </tr>
  ...
  <input type="hidden" name="bssid_num" value="4">
  <tr> 
  ...
  <tr id="div_apisoloate_single" style="display:none"> 
