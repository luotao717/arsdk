...
<blockquote>
<table width=700><tr><td><% checkSuperUser(); %>
...
<table width=100% border=0 cellpadding=3 cellspacing=1> 
  <tr>
    <td>
	  ...
	  <input type=button class=button3 name="multipleap" value="'+BT_security_setting+'" onClick="setWlanSecurity()">')</script><% needRebootWaring(); %>
    </td>
  </tr>
</table>
</form>  
