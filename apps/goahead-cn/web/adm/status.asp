...
function Load_Setting()
{
	...
	var wifi_off = '<% getCfgZero(1, "RadioOff"); %>';
...
<tr><td><script>dw(JS_msg_status)</script><% needRebootWaring(); %></td></tr>
<tr><td><hr></td></tr>
</table>
<br>
<table class="list">
...
<br><br>
<tr><td class="tcenter" align="center"><script>dw(MM_copyright_info)</script></td></tr>
</td></tr></table>
</blockquote>
</body></html>
