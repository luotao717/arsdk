...
function Load_Setting()
{
	...
	var connect1mode = <% getCfgZero(1, "Connect1OperationMode"); %>;
	var connect1ethports = "<% getCfgGeneral(1, "Connect1ethports"); %>";
	var connect2ethports = "<% getCfgGeneral(1, "Connect2ethports"); %>";
	var connect1wifiports = "<% getCfgGeneral(1, "Connect1wifiports"); %>";
	var connect2wifiports = "<% getCfgGeneral(1, "Connect2wifiports"); %>";
	var connect1vlanen = "<% getCfgGeneral(1, "Connect1vlanEn"); %>";
//	var connect1vlanid = "<% getCfgGeneral(1, "Connect1vlanid"); %>";
...
<tr id="vlantagRow">
  ...
  <td><input name="vlan1id" id="vlan1id" maxlength=17 value="<% getCfgGeneral(1, "Connect1vlanid"); %>"> 
  </td>
</tr>
<tr id="vlanprioRow">
  <td class="thead">vlan Priority:</td>
  <td><input name="vlan1prio" id="vlan1prio" maxlength=17 value="<% getCfgGeneral(1, "Connect1vlanprio"); %>"> 
  </td>
</tr>
</table>
