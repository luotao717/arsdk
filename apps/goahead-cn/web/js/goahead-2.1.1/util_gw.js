...
function saveChanges_wan(form)
{
  ...
  if ( wanType == 0 ){ //static IP
	...
	if (form.pppPassword.value != form.pppPassword2.value) {
			alert("Enter a different password twice.!");
			form.pppPassword.focus();
			return false;
		}
...
function progressBar( oBt, oBc, oBg, oBa, oWi, oHi, oDr ) 
{
  ...
  document.write( '<tr id = "progress_div" style="display:none"><td><table border="0" cellspacing="0" cellpadding="'+oBt+'">'+
