...
//	wan_mode=nvram_bufget(RT2860_NVRAM,"wanConnectionModeFlash");
//	strcpy(tmpBuf,wan_mode);
//	nvram_bufset(RT2860_NVRAM,"wanConnectionMode",tmpBuf);
...
{
        const char *value = nvram_get(2860,name);
